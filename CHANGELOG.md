...
### Released
- Shipped **briefing-intelligence-engine** as a public artifact for teams dealing with platform governance.
...
### Shipped
- Cut the first coherent internal version of **briefing-intelligence-engine** with stable domain objects, review surfaces, and decision outputs.
